...
export const registerSchema = z.object({
    ...
    tanggal_lahir: z.date({required_error: "Tanggal Lahir tidak boleh kosong"}).min(new Date("1900-01-01",), {message: "Tanggal Lahir tidak boleh kurang dari 1900-01-01"}).max(new Date(), {message: "Tanggal Lahir tidak boleh lebih dari hari ini"}),
    jenis_kelamin: z.string().min(1, {message: "Jenis Kelamin tidak boleh kosong"}),
    nik: z.string().min(1, {message: "No NIK tidak boleh kosong"}),
